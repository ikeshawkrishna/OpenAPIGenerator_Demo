...
public class Product {
  ...
  private @Nullable Integer availableQuantity;

  private @Nullable String status;

  public Product id(@Nullable Long id) {
    this.id = id;
    return this;
  }
  ...
  public Product availableQuantity(@Nullable Integer availableQuantity) {
  ...
  public @Nullable Integer getAvailableQuantity() {
    return availableQuantity;
  }

  public void setAvailableQuantity(@Nullable Integer availableQuantity) {
    this.availableQuantity = availableQuantity;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, product.id) &&
        ...
        Objects.equals(this.availableQuantity, product.availableQuantity) &&
        Objects.equals(this.status, product.status);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, description, price, category, availableQuantity, status);
  }
